...
using Snapshot = Cam.Persistence.Snapshot;
using System.IO;
...
namespace Cam.Plugins
{
    public class RpcSystemAssetTrackerPlugin : Plugin, IPersistencePlugin, IRpcPlugin
    {
        ...
        private Cam.IO.Data.LevelDB.Snapshot _levelDbSnapshot;
        ...
        private JObject ProcessGetUnspents(JArray _params)
        {
            ...
            byte startingToken = 0; // 0 = Utility Token (GAS), 1 = Governing Token (CAM)
            int maxIterations = 2;
            ...
            string[] nativeAssetNames = {"GAS", "CAM"};
